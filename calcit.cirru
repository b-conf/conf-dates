    ...
    'app.comp.container $ %{} 'FileEntry
      :defs $ {}
          ...
          :code $ quote $ defn arrange-list (acc confs previous-conf)
            if (empty? confs)
              ...
              let
                ...
                recur
                  conj acc $ comp-card conf previous-conf $ first (rest confs)
                  rest confs
        ...
        'comp-container $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defcomp comp-container (reel)
            let
                ...
                schedule $ unsafe-coerce
                  reel.schema/read-field store :confs
                  :: 'List 'app.types/Conf
        ...
        'date-to-format $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defn date-to-format (d fmt)
        ...
        'effect-scroll $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defeffect effect-scroll (schedule) (action el at?)
            when (some? schedule)
              js/setTimeout
                fn () $ js/document.body.scrollTo 0 $ wo-log
                  .-offsetTop $ unsafe-coerce
                    js/document.querySelector |#today
                    , js-object
                , 300
          :examples $ []
          :schema $ :: 'Fn $ {} (:return 'Dynamic)
        ...
        'start-of-day $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defn start-of-day (d)
    ...
    'app.main $ %{} 'FileEntry
      :defs $ {}
        ...
        'schedule-url $ %{} 'CodeEntry (:doc |)
          :code $ quote $ def schedule-url
            str |//r.tiye.me/b-conf/chinese-tech-conf-schedule/ config/year |.json
          :examples $ []
          :schema $ :: 'Dynamic
      :ns $ %{} 'NsEntry (:doc |)
